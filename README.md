...
### 2.1 스프링부트 프로젝트 실행 or 배포를 위한 Jar 패키지 빌드하기
...
#### 3.3.2 XML 설정 import
- `@ImportResource` 애노테이션을 사용하여 XML 설정파일을 import 할 수 있다.